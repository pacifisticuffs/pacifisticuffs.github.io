...
<dl>
  <dt><h6><b>Q.</b> What is CSS selector specificity and how does it work?</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> What's the difference between "resetting" and "normalizing" CSS? Which would you choose, and why?</h6></dt>
  <dd>
...
{% endhighlight %}
  ...
  <dt><h6><b>Q.</b> Describe z-index and how stacking context is formed.</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> Describe BFC (Block Formatting Context) and how it works.</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> How would you approach fixing browser-specific styling issues?</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> How do you serve your pages for feature-constrained browsers?</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> What are the different ways to visually hide content (and make it available only for screen readers)?</h6></dt>
  <dd>
...
{% endhighlight %}  
  ...
  <dt><h6><b>Q.</b> Have you ever used a grid system, and if so, what do you prefer?</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> Are you familiar with styling SVG?</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> Can you give an example of an <code>@media</code> property other than screen?</h6></dt>
  <dd>
  <p>Sure, you can do <code>@media print</code> to alter styles for when a user prints a page. </p>
  </dd>
  <dt><h6><b>Q.</b> What are the advantages/disadvantages of using CSS preprocessors?</h6></dt>
  <dd>
...
{% endhighlight %}
  ...
  <dt><h6><b>Q.</b> Describe pseudo-elements and discuss what they are used for (also looking at pseudo-classes here)</h6></dt>
  <dd>
  ...
  <dt><h6><b>Q.</b> Explain your understanding of the box model and how you would tell the browser in CSS to render your layout in different box models.<br />What does <code>* { box-sizing: border-box; }</code> do? What are its advantages?</h6></dt>
  <dd>
